...
public class Align2Rander {
	public static void ColToRdf(String ont1, String ont2, ArrayList<Align> AlignTab, String filename)
		...
		for (Align AlignTab1 : AlignTab) {
			...
			if (AlignTab1.E1 != null && AlignTab1.E2 != null) {
				alignment.addAlignCell(AlignTab1.E2, AlignTab1.E1, "=", AlignTab1.Sim);
